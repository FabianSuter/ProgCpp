...
\setboolean{tikzumlWorks}{false} % false = tikzumlpackage NOT installed

\newboolean{svgWorks}
\setboolean{svgWorks}{false} % false = svg package NOT installed
...
\date{{\small 1.1.6, erweitert von Fabian Steiner}}
...
\begin{document}
	\begin{multicols*}{3}
        ...
        \input{Sections/05_Snippets.tex}
